            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-sm-offset-3">
                        ...
                        <h1 class="module-title align-center">Looking for a Freelance Shopify Theme Developer?</h1>

                        <div class="module-subtitle align-center">
                            <p class="lead">You've come to the right place. Find out more about Shopify and how I can help your new online business.</p>
                        </div>
                    </div>
...
<ul>
	...
	<li>Responsive Framework so your store work on mobile</li>
...
This in essence saves your businesses money and time as a basic store could be trading in a matter of days - not months.</p>
						...
						<ul>
							<li>Research & agree requirements</li>
							<li>Design the UX & and wireframes and user journeys</li>
							<li>Design the UI</li>
							<li>Develop the site</li>
							<li>Test the site on multiple devices and browsers</li>
							<li>Launch the website so you can trade online</li>
