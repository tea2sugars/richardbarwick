			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-6 col-sm-offset-3">
						...
						<h1 class="module-title align-center">Buyapowa Social Commerce Website<br/><span class="small">The Debenhams Lingerie Co-Buy Shop</span></h1>
					...
					<div class="col-md-4">
						<div class="work-details">
							<ul>
								...
								<li><strong>Project: </strong>UX and Website Design</li>
