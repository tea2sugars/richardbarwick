...
<body>
	...
	<!-- HOME -->
	<section class="module module-header bg-dark bg-dark-50" data-background="../assets/images/projects/Domenico_general_header.jpg">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-8 col-sm-offset-4">
						...
						<p><img src="../assets/images/projects/Domenico_portfolio_04.jpg" alt="Domenico Website Design"></p>
					</div>
				</div>
				...
				<div class="row m-t-70">
					...
					<div class="col-md-4">
						<div class="work-details">
							<ul>
								<li><strong>Client: </strong>Domenico</li>
								<li><strong>Project: </strong>Branding, Print and Website Design</li>
			...
			<div class="container">
				...
				<div class="row">
					...
					<!--<div class="col-sm-12">-->
						...
						<p><img src="../assets/images/projects/Domenico_portfolio_05.jpg" alt="Domenico Website Design"></p>
