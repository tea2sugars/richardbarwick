...
<head>
	...
	<meta name="description" content="Rik Barwick's Freelance Website Design and Branding Portfolio">
	...
	<div class="wrapper">
		...
		<section class="module-small p-b-60">
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<ul id="filters" class="filter hidden-xs">
							...
							<li><a href="#" data-filter=".artdirection" class="wow fadeInUp" data-wow-delay="0.2s">Art Direction</a></li>
							<li><a href="#" data-filter=".branding" class="wow fadeInUp" data-wow-delay="0.2s">Branding</a></li>
							<li><a href="#" data-filter=".digital" class="wow fadeInUp" data-wow-delay="0.2s">Digital Production Management</a></li>
							<li><a href="#" data-filter=".frontend" class="wow fadeInUp" data-wow-delay="0.2s">Front-End Development</a></li>
							<li><a href="#" data-filter=".ux" class="wow fadeInUp" data-wow-delay="0.2s">UX Design</a></li>
							<li><a href="#" data-filter=".ui" class="wow fadeInUp" data-wow-delay="0.2s">UI Design</a></li>-->
						</ul>
			...
			<ul id="works-grid" class="works-grid works-grid-4 works-hover-w">
				...
				<li class="work-item digital ux branding artdirection">
					<a href="hsbc">
						...
						<div class="work-caption">
							...
							<div class="work-descr ">
								UX, UI and Branding Art Direction
							</div>
						</div>
					</a>
				</li>
				...
				<!-- PORTFOLIO ITEM -->
				<li class="work-item artdirection digital">
				...
				<!-- PORTFOLIO ITEM -->
				<li class="work-item artdirection digital ux">
					<a href="domenico">
						<div class="work-image">
				...
				<!-- PORTFOLIO ITEM -->
				<li class="work-item branding artdirection digital">
