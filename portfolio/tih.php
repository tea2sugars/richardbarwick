...
<body>
	...
	<!-- HOME -->
	<section class="module module-header bg-dark bg-dark-50" data-background="../assets/images/projects/tih/tih_general_header.jpg">
				...
				<div class="row m-t-70">
					...
					<div class="col-md-4">
						<div class="work-details">
							<ul>
								<li><strong>Client: </strong>The Interior House</li>
								<li><strong>Agency: </strong><a href="https://www.jtfmarketing.com" target="_blank">JTF Marketing</a></li>
								<li><strong>Project: </strong>Shopify Theme Development</li>
								<li><strong>Online: </strong><a href="https://the-interior-house.myshopify.com" target="_blank">https://the-interior-house.myshopify.com</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-11 col-sm-offset-1">
						<img src="../assets/images/projects/TIH/tih_portfolio_01.jpg" alt="tih_portfolio_01">
					</div>
					...
					<div class="col-md-11 col-sm-offset-1">
						<p><img src="../assets/images/projects/TIH/tih_portfolio_02.jpg" alt="tih_portfolio_02"></p>
						<p><img src="../assets/images/projects/TIH/tih_portfolio_03.jpg" alt="tih_portfolio_03"></p>
					</div>
				</div>
		</section>
