...
<head>
    ...
    <meta name="description" content="A London & Suffolk based Website Design Consultant working to support clients with elegant design and excellent client services.">
...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- HOME -->
        <section class="module module-header bg-dark bg-dark-50" data-background="assets/images/digital_support_header.jpg">
        ...
        <section class="module-small light-grey-section" id="digital-suuport">
