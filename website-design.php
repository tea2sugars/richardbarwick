...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- HOME -->
        <section class="module module-header bg-dark bg-dark-50" data-background="assets/images/digital_design_header.jpg">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <article>
                            ...
                            <h2>Website design that works</h2>
                            <h3>I'm a digital professional that prides himself in his creative thinking, technical knowhow and a thirst for customer satisfaction.</h3>
                            <p>Over the years I've worked independently or with experienced digital designers, strategists and developers that can adapt existing services, innovate and develop digital projects that cater for any budget and timeframe. With creative digital thinking there's always a way!</p>
        ...
        <section class="module-small light-grey-section" id="shopify-design-services">
	        <div class="container">
                <div class="row">
    ...
    <section class="module-small p-t-20 p-t-sm-0" id="portfolio">
        <div class="container-fluid">
            <div class="row">
                <h2 class="align-center">Website Design Projects</h2>
            </div>
