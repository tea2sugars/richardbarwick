...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- HOME -->
        <section class="module module-header bg-dark bg-dark-50" data-background="assets/images/web_header.jpg">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <article>
                            ...
                            <h3>I'm a Digital Design consultant that creates simple solutions to complicated problems.</h3>
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <article>
                            ...
                            <p>WI provide website design for clients all over Great Britain from London to Glasgow so please in touch if you have something you want to have a chat about regarding your digital world and let's see how I can help you with your project.</p>
                        </article>
